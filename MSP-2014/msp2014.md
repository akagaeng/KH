...
## 문제1
- 구구단의 단을 입력 받아 *로 출력하라. 

> 입력 받은 수가 1~9 사이의 수인지 확인한다.<br>
> 잘못 입력한 경우 다시 입력을 받고,
...
> 괄호 문자열을 입력 받는다.<br>
> 입력 받은 괄호 문자열이 한 쌍의 괄호 기호로 된 "( )" 인지 아닌지를 판단해서 그 결과를 YES 와 NO로 나타낸다.<br>
...
>- c. 예를 들면, 문자열 "THE EYES"와 "THEY SEE"는 서로 아나그램이라고 할 수 있다.<br>이 두 문자열은 알파벳 E가 3개, H가 1개, T가 1개, S가 1개, Y가 1개로 같은 구성의 알파벳으로 형성되어 있기 때문이다.
...
힌트 및 유의사항
> 1~300 사이의  정수를 입력 받고, 입력 받은 정수 사이에 소수를 출력한다.<br>
...
## [문제15](http://cafe.naver.com/mspforever/2757)
- 팔찌 만들기
...
## [문제16](http://cafe.naver.com/mspforever/2758)
- 볼링 스코어 계산하기
...
## [문제17](http://cafe.naver.com/mspforever/2759)
- 64 게임 만들기
...
>- f) 밀어내는 과정에서 병합할 수 있는 숫자가 있다면 모두 병합한다.<br>* 병합에 대한 자세한 방법은 첨부된 PDF 파일을 참조하세요.
